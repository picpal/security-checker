...
| GT-A 수정 커밋 | `72e49a1b`(259) / `55e58bc6`(760) / `8428e646`(#305) / `5895c9f4`(489) / `81f4f31b`(676·497) / `b742368e`(476) |
...
| 측정 후 분류 | 489 활성 디버그(management 포트) / 497 자격증명 마스킹 / 312·314 민감정보 저장·전송 | 기존 팩 탐지 여부를 측정하고 범주 내/외로 사후 확정. 분모 조정 금지 — 결과와 무관하게 표에 남긴다 |
