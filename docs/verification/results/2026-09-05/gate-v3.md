...
- 미통과: 축 7 GT-A differential(범주 내) — gta.in_category_pass 2/4 <!-- fact:gta.in_category_pass --> 가 기준(spec §5: 범주 내 출현·소멸 100%) 미달. row2·row3(CWE-89, `#305`)이 FAIL — fixed_residual 8 <!-- fact:gta.row2.CWE-89.fixed_residual -->건·5 <!-- fact:gta.row3.CWE-89.fixed_residual -->건(위 표).
