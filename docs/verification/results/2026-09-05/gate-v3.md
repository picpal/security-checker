...
| 7 measure-then-classify | 결과 기록만(게이트 없음) | CWE-489 관측 없음 <!-- fact:gta.CWE-489.application.observed --> · CWE-497 관측 없음 <!-- fact:gta.CWE-497.TestDbReset.observed --> | 기록 |
...
- 미통과: 축 7 GT-A differential(범주 내) — gta.in_category_pass 2/4 <!-- fact:gta.in_category_pass --> 가 기준(spec §5: 범주 내 출현·소멸 100%) 미달. row2·row3(CWE-89, `#305`)이 FAIL — fixed_residual 8 <!-- fact:gta.CWE-89.LgCarrierMapper.fixed_residual -->건·5 <!-- fact:gta.CWE-89.OldLgCarrierMapper.fixed_residual -->건(위 표).
