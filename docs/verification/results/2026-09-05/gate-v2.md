...
| 4 초과분 | 미분류 0 | 초과 1 <!-- fact:sca.extras --> · inventory-diff 1 <!-- fact:sca.extras.inventory-diff --> · 미분류 0(facts.json 에 `sca.extras.미분류` 키 없음 = inventory-diff 합이 sca.extras 와 일치, 전건 분류됨) | ✓ |
