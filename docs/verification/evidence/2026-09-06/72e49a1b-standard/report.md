...
### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `eead0bd82689`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `2889b721807e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `bdb268a744ed`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/application-example.yml:69 · id `eaf70896c87c`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/application-loadtest.yml:115 · id `0b12a6b84bb8`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `221952a383da`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/src/test/resources/application-test.yml:110 · id `88857785cfbf`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/72e49a1b/repo/src/test/resources/application-test.yml:61 · id `40b40c49e08a`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/72e49a1b/repo/src/test/resources/tls/test-server.key:1 · id `ab9e58d45479`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/72e49a1b/repo/.github/workflows/package-src.yml:36 · id `14d03eef2af8`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/72e49a1b/repo/.github/workflows/package-src.yml:49 · id `a8d765de2e19`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `ab9ef740cf84`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `a959c562b418`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:24 · id `b62c42c8cde4`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `a4f07320ec55`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:41 · id `07ff2a0c0bb5`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/72e49a1b/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:60 · id `68a7bcc92332`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
