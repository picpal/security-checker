...
### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `018f0f7910b7`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `709fb10ee515`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `30cb838341ae`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/application-example.yml:69 · id `fdaba8697655`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/application-loadtest.yml:113 · id `4b3d1a582693`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `4d57c803083d`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/src/test/resources/application-test.yml:110 · id `34aac7afd14b`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/5895c9f4/repo/src/test/resources/application-test.yml:61 · id `a2232f3f68fd`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/5895c9f4/repo/src/test/resources/tls/test-server.key:1 · id `ac1513bb065b`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/5895c9f4/repo/.github/workflows/package-src.yml:36 · id `7929b269a8e4`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/5895c9f4/repo/.github/workflows/package-src.yml:49 · id `825145991e4d`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [위험] secscan.rules.hardcoded-credential — /private/tmp/secscan-verify/5895c9f4/repo/src/main/java/com/messagegate/config/LoadtestSeederConfig.java:31 · id `fd1e24f86992`
- CWE-798 CWE-259 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA 하드코드된 중요정보 · PCI-DSS 6.2.4 — access control

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `3d50c0f8c813`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `1105e1658926`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:24 · id `19fc0949411f`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `7f961f13f0fc`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:41 · id `bec66bdbb99d`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/5895c9f4/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:60 · id `2516e8352d00`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
