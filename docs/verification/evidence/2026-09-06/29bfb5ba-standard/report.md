...
### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `ff1360e1bf60`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `ffc2649bce5a`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `cf6a98fbb0d1`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/application-example.yml:69 · id `713ccb2e1fbb`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/application-loadtest.yml:113 · id `77dd18494923`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `37bfbe55b88a`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/test/resources/application-test.yml:110 · id `81ab47cab2b2`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/test/resources/application-test.yml:61 · id `c37dc6dd7f10`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/29bfb5ba/repo/src/test/resources/tls/test-server.key:1 · id `f57bb408446e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/29bfb5ba/repo/.github/workflows/package-src.yml:36 · id `75f16859f794`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/29bfb5ba/repo/.github/workflows/package-src.yml:49 · id `4f4c4c032b60`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [위험] secscan.rules.hardcoded-credential — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/java/com/messagegate/config/LoadtestSeederConfig.java:31 · id `1dc1428dd8a6`
- CWE-798 CWE-259 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA 하드코드된 중요정보 · PCI-DSS 6.2.4 — access control

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `057bc5a67854`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `418bc4ab8303`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:24 · id `e2024e7b5c38`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `76f93b294257`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:41 · id `693db6d76867`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/29bfb5ba/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:60 · id `42a6050a1d21`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
