...
### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `342ba29790be`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `770d982274c7`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `1110ed8bc026`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/application-example.yml:69 · id `121f25597d11`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/application-loadtest.yml:113 · id `a4096463f97d`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `1f04f448527a`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/test/resources/application-test.yml:110 · id `c61d50d66b93`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/test/resources/application-test.yml:61 · id `afe60907da7e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/d4a1ded0/repo/src/test/resources/tls/test-server.key:1 · id `6044923202b3`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/d4a1ded0/repo/.github/workflows/package-src.yml:36 · id `7545948c3a27`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/d4a1ded0/repo/.github/workflows/package-src.yml:49 · id `f5247c6f6adc`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [위험] secscan.rules.zero-salt — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/java/com/messagegate/config/LoadtestSeederConfig.java:30 · id `68387b6d634f`
- CWE-760 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA 솔트 없이 일방향 해시함수 사용 · PCI-DSS 6.2.4 — cryptography

### [위험] secscan.rules.hardcoded-credential — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/java/com/messagegate/config/LoadtestSeederConfig.java:31 · id `bf82146407a0`
- CWE-798 CWE-259 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA 하드코드된 중요정보 · PCI-DSS 6.2.4 — access control

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `6422d8307d9e`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `a2867aafdb2e`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:24 · id `966c5d20e80b`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `2eeeed64e07f`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:41 · id `e966012021af`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/d4a1ded0/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:60 · id `571c9c9a64a5`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
