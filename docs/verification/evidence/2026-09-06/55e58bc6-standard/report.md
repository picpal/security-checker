...
### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `6404e0c4b9a0`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `b92c94f8d5fb`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `4aa7aca2b3fe`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/application-example.yml:69 · id `86325ad407c3`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/application-loadtest.yml:113 · id `a38b8a3a264e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `df574be18867`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/src/test/resources/application-test.yml:110 · id `a63dc5458c55`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/55e58bc6/repo/src/test/resources/application-test.yml:61 · id `c74ff1aeefcc`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/55e58bc6/repo/src/test/resources/tls/test-server.key:1 · id `1bf357bbf213`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/55e58bc6/repo/.github/workflows/package-src.yml:36 · id `e8874a93c9fd`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)

### [보통] yaml.github-actions.security.github-actions-mutable-action-tag.github-actions-mutable-action-tag — /private/tmp/secscan-verify/55e58bc6/repo/.github/workflows/package-src.yml:49 · id `4229968968e1`
- CWE-1357 CWE-353 · 탐지: semgrep (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [위험] secscan.rules.hardcoded-credential — /private/tmp/secscan-verify/55e58bc6/repo/src/main/java/com/messagegate/config/LoadtestSeederConfig.java:31 · id `e9b1f61b1bb6`
- CWE-798 CWE-259 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA 하드코드된 중요정보 · PCI-DSS 6.2.4 — access control

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `96398afb6913`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `f64c82ac5b6a`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:24 · id `5a68a7577d26`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `62b2bc720ec5`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:41 · id `9faf295a81af`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/55e58bc6/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:60 · id `c934e6af5e34`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
