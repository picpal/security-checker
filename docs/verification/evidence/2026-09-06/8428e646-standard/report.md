...
### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:953 · id `a7f1d895672e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/docs/superpowers/plans/2026-05-20-sha512-password-encoder.md:970 · id `6190de2f81f7`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/docs/superpowers/plans/2026-06-07-kms-cbc-payload-encryption.md:182 · id `b21cebeb6427`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/application-example.yml:69 · id `822f4f0cba5e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/application-loadtest.yml:117 · id `7808244b76a6`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/src/test/java/com/messagegate/auth/AuthServiceTest.java:525 · id `224e7218c11e`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/src/test/resources/application-test.yml:110 · id `e340ad592a0f`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] generic-api-key — /private/tmp/secscan-verify/8428e646/repo/src/test/resources/application-test.yml:61 · id `def5acc0a494`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)

### [위험] private-key — /private/tmp/secscan-verify/8428e646/repo/src/test/resources/tls/test-server.key:1 · id `223b0c063e80`
- 하드코딩된 시크릿 — **즉시 회수(revoke)·교체**하고 코드/히스토리에서 제거
- 탐지: gitleaks (합의 1)
...
## 검토 후보 (낮은 신뢰)
### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/java/com/messagegate/mapper/lg/LgCarrierMapper.java:40 · id `6b49540adfea`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/java/com/messagegate/mapper/oldlg/OldLgCarrierMapper.java:58 · id `be3f408a2267`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/java/com/messagegate/mapper/oldlg/OldLgCarrierMapper.java:76 · id `3d67aef8188b`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:18 · id `b78f48a8b26c`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:19 · id `1663acfaa3ba`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/lg/LgCarrierMapper.xml:27 · id `7a80fd6c2561`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:35 · id `c3e421c4720d`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:36 · id `0aa4354039f8`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:44 · id `bd4114a310ae`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:58 · id `2d67d06cb0de`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection

### [보통] secscan.rules.mybatis-sqli-identifier — /private/tmp/secscan-verify/8428e646/repo/src/main/resources/mybatis/mapper/oldlg/OldLgCarrierMapper.xml:66 · id `d38bc2aa5d1b`
- CWE-89 · 탐지: semgrep (합의 1)
- 컴플라이언스: KISA SQL 삽입 · PCI-DSS 6.2.4 — injection
